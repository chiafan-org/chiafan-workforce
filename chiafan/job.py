    ...
    def to_payload(self):
        return {
            ...
            'stage': (self.running.name
                      if self.running is not RunningState.ONGOING
...
class PlottingJob(object):
    def __init__(self, job_name: str,
        ...
        self.proc = None
        self.thread = threading.Thread(PlottingJob.run, self)
        self.thread.Start()
    ...
    def run(self):
        ...
        self.plotting_space.mkdir(parents = True, exists_ok = True)
        self.destination.mkdir(parents = True, exists_ok = True)
